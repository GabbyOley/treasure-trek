...
export const HTML_BOARD_LAYOUT = {
  ...
  jungleRejoin: { x: 76, y: 52 },
  finalChoice: { x: 80, y: 52 },
  meadow1: { x: 84, y: 24 },
  meadow2: { x: 89, y: 24 },
  pond1: { x: 84, y: 52 },
  pond2: { x: 89, y: 52 },
  ...
  river4: { x: 92, y: 76 },
  river5: { x: 96, y: 76 },
  shipwreck1: { x: 84, y: 88 },
  shipwreck2: { x: 90, y: 88 },
  shipwreck3: { x: 96, y: 88 },
...
export const HTML_BOARD_ROUTE_TRACKS = [
  ...
  {
    id: "meadow-lane",
    spaceIds: ["final-choice", "meadow-1", "meadow-2", "finish-gate"],
  },
  {
    id: "pond-lane",

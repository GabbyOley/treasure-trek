...
export const HTML_BOARD_LAYOUT = {
  ...
  swampEntry: { x: 88, y: 64 },
  swampCoin: { x: 91, y: 74 },
  swampTrap: { x: 94, y: 66 },
  swampAction: { x: 97, y: 76 },
  swampRejoin: { x: 94, y: 57 },
  cliff1: { x: 91, y: 67 },
  cliffEvent: { x: 88, y: 79 },
  cliffTrap: { x: 83, y: 70 },
  cliffShop: { x: 76, y: 61 },
  jungleEntry: { x: 70, y: 57 },
  jungleCoin: { x: 65, y: 58 },
  jungleFork: { x: 60, y: 57 },
  deepJungle1: { x: 62, y: 73 },
  deepJungle2: { x: 67, y: 84 },
  deepJungle3: { x: 73, y: 78 },
  deepJungle4: { x: 78, y: 67 },
  jungleEvent: { x: 63, y: 42 },
  jungleCoin2: { x: 69, y: 35 },
  jungleRejoin: { x: 74, y: 43 },
  finalChoice: { x: 79, y: 52 },
  meadow1: { x: 85, y: 24 },
  meadow2: { x: 92, y: 15 },
  pond1: { x: 86, y: 48 },
  pond2: { x: 93, y: 52 },
  ...
  river4: { x: 98, y: 82 },
  river5: { x: 96, y: 69 },
  shipwreck1: { x: 90, y: 65 },
  shipwreck2: { x: 97, y: 58 },
  shipwreck3: { x: 90, y: 43 },
  finishGate: { x: 95, y: 31 },
  finish: { x: 99, y: 36 },
} as const;

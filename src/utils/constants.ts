...
export const HTML_BOARD_LAYOUT = {
  ...
  cliffTrap: { x: 84, y: 70 },
  cliffShop: { x: 80, y: 60 },
  jungleEntry: { x: 75, y: 58 },
  jungleCoin: { x: 70, y: 58 },
  jungleFork: { x: 65, y: 58 },
  deepJungle1: { x: 66, y: 73 },
  deepJungle2: { x: 71, y: 82 },
  deepJungle3: { x: 77, y: 78 },
  deepJungle4: { x: 82, y: 68 },
  jungleEvent: { x: 67, y: 43 },
  jungleCoin2: { x: 74, y: 36 },
  jungleRejoin: { x: 82, y: 44 },
  finalChoice: { x: 86, y: 52 },
  meadow1: { x: 89, y: 27 },
  meadow2: { x: 94, y: 18 },
  pond1: { x: 91, y: 48 },
  pond2: { x: 96, y: 53 },
  ...
  river4: { x: 98, y: 77 },
  river5: { x: 96, y: 66 },
  shipwreck1: { x: 92, y: 59 },
  shipwreck2: { x: 98, y: 50 },
  shipwreck3: { x: 92, y: 42 },
  finishGate: { x: 94, y: 34 },
  finish: { x: 98, y: 35 },
} as const;

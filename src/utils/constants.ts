...
export const HTML_BOARD_LAYOUT = {
  ...
  campEvent: { x: 17, y: 48 },
  campFork: { x: 21, y: 48 },
  fieldEntry: { x: 27, y: 30 },
  fieldAction: { x: 32, y: 30 },
  fieldEvent: { x: 37, y: 30 },
  fieldCoin: { x: 42, y: 30 },
  fieldBlank: { x: 47, y: 30 },
  caveMouth: { x: 27, y: 66 },
  caveCoin: { x: 32, y: 66 },
  caveTrap: { x: 37, y: 66 },
  caveTreasure: { x: 42, y: 66 },
  caveEvent: { x: 47, y: 66 },
  rejoinBridge: { x: 52, y: 48 },
  lookoutBlank: { x: 56, y: 48 },
  lookoutCoin: { x: 60, y: 48 },
  lookoutEvent: { x: 64, y: 48 },
  sliceEnd: { x: 68, y: 48 },
  volcanoAsh: { x: 56, y: 66 },
  volcanoCoin: { x: 60, y: 66 },
  volcanoTrap: { x: 64, y: 66 },
  volcanoAction: { x: 68, y: 66 },
  volcanoEvent: { x: 72, y: 66 },
  waterfallFork: { x: 74, y: 48 },
  waterfall1: { x: 76, y: 14 },
  waterfall2: { x: 80, y: 14 },
  waterfall3: { x: 84, y: 14 },
  waterfall4: { x: 88, y: 14 },
  waterfall5: { x: 92, y: 14 },
  swampEntry: { x: 76, y: 66 },
  swampCoin: { x: 80, y: 66 },
  swampTrap: { x: 84, y: 66 },
  swampAction: { x: 88, y: 66 },
  swampRejoin: { x: 92, y: 66 },
  cliff1: { x: 68, y: 78 },
  cliffEvent: { x: 64, y: 78 },
  cliffTrap: { x: 60, y: 78 },
  cliffShop: { x: 56, y: 78 },
  jungleEntry: { x: 52, y: 78 },
  jungleCoin: { x: 48, y: 78 },
  jungleFork: { x: 44, y: 78 },
  deepJungle1: { x: 44, y: 90 },
  deepJungle2: { x: 48, y: 90 },
  deepJungle3: { x: 52, y: 90 },
  deepJungle4: { x: 56, y: 90 },
  jungleEvent: { x: 48, y: 58 },
  jungleCoin2: { x: 54, y: 58 },
  jungleRejoin: { x: 64, y: 58 },
  finalChoice: { x: 72, y: 48 },
  meadow1: { x: 80, y: 24 },
  meadow2: { x: 92, y: 24 },
  pond1: { x: 79, y: 48 },
  pond2: { x: 86, y: 48 },
  ...
  river4: { x: 88, y: 84 },
  river5: { x: 92, y: 84 },
  shipwreck1: { x: 86, y: 94 },
  shipwreck2: { x: 92, y: 94 },
  shipwreck3: { x: 98, y: 94 },
  finishGate: { x: 97, y: 48 },
  finish: { x: 99, y: 36 },
} as const;
...
export const HTML_BOARD_CLEAN_TRACKS = [
  { id: "main", start: { x: 5, y: 48 }, end: { x: 21, y: 48 } },
  { id: "field-branch", start: { x: 21, y: 48 }, end: { x: 27, y: 30 } },
  { id: "field-branch", start: { x: 27, y: 30 }, end: { x: 47, y: 30 } },
  { id: "field-branch", start: { x: 47, y: 30 }, end: { x: 52, y: 48 } },
  { id: "cave-branch", start: { x: 21, y: 48 }, end: { x: 27, y: 66 } },
  { id: "cave-branch", start: { x: 27, y: 66 }, end: { x: 47, y: 66 } },
  { id: "cave-branch", start: { x: 47, y: 66 }, end: { x: 52, y: 48 } },
  { id: "main", start: { x: 52, y: 48 }, end: { x: 74, y: 48 } },
  { id: "cave-branch", start: { x: 68, y: 48 }, end: { x: 56, y: 66 } },
  { id: "cave-branch", start: { x: 56, y: 66 }, end: { x: 72, y: 66 } },
  { id: "cave-branch", start: { x: 72, y: 66 }, end: { x: 74, y: 48 } },
  { id: "field-branch", start: { x: 74, y: 48 }, end: { x: 76, y: 14 } },
  { id: "field-branch", start: { x: 76, y: 14 }, end: { x: 92, y: 14 } },
  { id: "field-branch", start: { x: 92, y: 14 }, end: { x: 92, y: 66 } },
  { id: "cave-branch", start: { x: 74, y: 48 }, end: { x: 76, y: 66 } },
  { id: "cave-branch", start: { x: 76, y: 66 }, end: { x: 92, y: 66 } },
  { id: "cave-branch", start: { x: 92, y: 66 }, end: { x: 68, y: 78 } },
  { id: "cave-branch", start: { x: 44, y: 78 }, end: { x: 68, y: 78 } },
  { id: "field-branch", start: { x: 44, y: 78 }, end: { x: 48, y: 58 } },
  { id: "field-branch", start: { x: 48, y: 58 }, end: { x: 64, y: 58 } },
  { id: "cave-branch", start: { x: 44, y: 78 }, end: { x: 44, y: 90 } },
  { id: "cave-branch", start: { x: 44, y: 90 }, end: { x: 56, y: 90 } },
  { id: "cave-branch", start: { x: 56, y: 90 }, end: { x: 64, y: 58 } },
  { id: "main", start: { x: 64, y: 58 }, end: { x: 72, y: 48 } },
  { id: "field-branch", start: { x: 72, y: 48 }, end: { x: 80, y: 24 } },
  { id: "field-branch", start: { x: 80, y: 24 }, end: { x: 92, y: 24 } },
  { id: "main", start: { x: 72, y: 48 }, end: { x: 97, y: 48 } },
  { id: "cave-branch", start: { x: 72, y: 48 }, end: { x: 76, y: 84 } },
  { id: "cave-branch", start: { x: 76, y: 84 }, end: { x: 96, y: 84 } },
  { id: "cave-branch", start: { x: 96, y: 84 }, end: { x: 98, y: 94 } },
  { id: "cave-branch", start: { x: 86, y: 94 }, end: { x: 98, y: 94 } },
  { id: "main", start: { x: 97, y: 48 }, end: { x: 99, y: 36 } },
] as const;

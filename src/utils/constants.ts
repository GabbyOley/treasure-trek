...
export const HTML_BOARD_LAYOUT = {
  ...
  campEvent: { x: 24, y: 58 },
  campFork: { x: 29, y: 52 },
  fieldEntry: { x: 33, y: 36 },
  fieldAction: { x: 38, y: 30 },
  fieldEvent: { x: 43, y: 36 },
  fieldCoin: { x: 48, y: 30 },
  fieldBlank: { x: 53, y: 40 },
  caveMouth: { x: 33, y: 68 },
  caveCoin: { x: 38, y: 76 },
  caveTrap: { x: 43, y: 68 },
  caveTreasure: { x: 48, y: 76 },
  caveEvent: { x: 53, y: 64 },
  rejoinBridge: { x: 58, y: 52 },
  lookoutBlank: { x: 62, y: 42 },
  lookoutCoin: { x: 66, y: 50 },
  lookoutEvent: { x: 70, y: 42 },
  sliceEnd: { x: 74, y: 52 },
  volcanoAsh: { x: 76, y: 36 },
  volcanoCoin: { x: 79, y: 26 },
  volcanoTrap: { x: 82, y: 32 },
  volcanoAction: { x: 85, y: 25 },
  volcanoEvent: { x: 87, y: 36 },
  waterfallFork: { x: 89, y: 50 },
  waterfall1: { x: 87, y: 30 },
  waterfall2: { x: 90, y: 20 },
  waterfall3: { x: 93, y: 29 },
  waterfall4: { x: 96, y: 21 },
  waterfall5: { x: 97, y: 38 },
  swampEntry: { x: 89, y: 66 },
  swampCoin: { x: 92, y: 79 },
  swampTrap: { x: 96, y: 68 },
  swampAction: { x: 98, y: 82 },
  swampRejoin: { x: 93, y: 57 },
  cliff1: { x: 88, y: 70 },
  cliffEvent: { x: 83, y: 84 },
  cliffTrap: { x: 78, y: 72 },
  cliffShop: { x: 73, y: 60 },
  jungleEntry: { x: 68, y: 56 },
  jungleCoin: { x: 63, y: 58 },
  jungleFork: { x: 58, y: 56 },
  deepJungle1: { x: 58, y: 74 },
  deepJungle2: { x: 63, y: 88 },
  deepJungle3: { x: 69, y: 80 },
  deepJungle4: { x: 74, y: 68 },
  jungleEvent: { x: 62, y: 38 },
  jungleCoin2: { x: 69, y: 29 },
  jungleRejoin: { x: 72, y: 40 },
  ...
  river4: { x: 95, y: 79 },
  river5: { x: 91, y: 66 },
  shipwreck1: { x: 84, y: 66 },
  shipwreck2: { x: 91, y: 55 },
  shipwreck3: { x: 84, y: 43 },
  finishGate: { x: 91, y: 31 },
  finish: { x: 97, y: 35 },
} as const;

export const HTML_BOARD_CONNECTION_BENDS = {
  "final-choice>meadow-1": [{ x: 74, y: 18 }],
  "meadow-2>finish-gate": [
    { x: 89, y: 24 },
    { x: 91, y: 31 },
  ],
  "final-choice>pond-1": [{ x: 78, y: 45 }],
  "pond-3>finish-gate": [
    { x: 81, y: 66 },
    { x: 91, y: 31 },
  ],
  "final-choice>river-1": [{ x: 74, y: 76 }],
  "shipwreck-2>shipwreck-3": [
    { x: 91, y: 43 },
  ],
  "shipwreck-3>finish-gate": [
    { x: 84, y: 31 },
  ],
} as const;

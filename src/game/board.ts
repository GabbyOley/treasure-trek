...
export const BOARD_SPACES: readonly BoardSpace[] = [
  ...
  },
  {
    ...
    region: "Volcano",
    risk: "danger",
    nextSpaceIds: ["volcano-coin"],
    position: BOARD_POSITION_HINTS.volcanoAsh,
  },
  {
    id: "volcano-coin",
    name: "Obsidian Cache",
    ...
    region: "Volcano",
    risk: "danger",
    nextSpaceIds: ["volcano-trap"],
    position: BOARD_POSITION_HINTS.volcanoCoin,
  },
  {
    id: "volcano-trap",
    name: "Lava Crack",
    ...
    position: BOARD_POSITION_HINTS.volcanoTrap,
  },
  {
    id: "volcano-action",
    name: "Gold Mine",
  ...
  },
  {
    ...
    region: "Volcano",
    risk: "danger",
    nextSpaceIds: ["waterfall-fork"],
    position: BOARD_POSITION_HINTS.volcanoEvent,
  },
  {
    id: "waterfall-fork",
    name: "Mist Fork",
    ...
    region: "Waterfall",
    risk: "safe",
    nextSpaceIds: ["swamp-entry", "waterfall-1"],
    position: BOARD_POSITION_HINTS.waterfallFork,
  },
  {
    id: "waterfall-1",
    name: "Spray Stones",
    ...
    region: "Waterfall",
    risk: "safe",
    nextSpaceIds: ["waterfall-2"],
    position: BOARD_POSITION_HINTS.waterfall1,
  },
  {
    id: "waterfall-2",
    name: "Rainbow Pool",
    ...
    region: "Waterfall",
    risk: "safe",
    nextSpaceIds: ["waterfall-3"],
    position: BOARD_POSITION_HINTS.waterfall2,
  },
  {
    id: "waterfall-3",
    name: "Hidden Falls",
    ...
    region: "Waterfall",
    risk: "safe",
    nextSpaceIds: ["waterfall-4"],
    position: BOARD_POSITION_HINTS.waterfall3,
  },
  {
    id: "waterfall-4",
    name: "Falling Mist",
    ...
    region: "Waterfall",
    risk: "safe",
    nextSpaceIds: ["waterfall-5"],
    position: BOARD_POSITION_HINTS.waterfall4,
  },
  {
    id: "waterfall-5",
    ...
    region: "Waterfall",
    risk: "safe",
    nextSpaceIds: ["swamp-rejoin"],
    position: BOARD_POSITION_HINTS.waterfall5,
    miniQuestId: "buried-treasure",
  },
  {
    id: "swamp-entry",
    ...
    region: "Swamp",
    risk: "danger",
    nextSpaceIds: ["swamp-coin"],
    position: BOARD_POSITION_HINTS.swampEntry,
  },
  {
    id: "swamp-coin",
    name: "Bog Coins",
    ...
    region: "Swamp",
    risk: "danger",
    nextSpaceIds: ["swamp-trap"],
    position: BOARD_POSITION_HINTS.swampCoin,
  },
  {
    id: "swamp-trap",
    name: "Sinking Mud",
    ...
    position: BOARD_POSITION_HINTS.swampTrap,
  },
  {
    id: "swamp-action",
    name: "Fishing Spot",
  ...
  },
  {
    ...
    region: "Swamp",
    risk: "danger",
    nextSpaceIds: ["cliff-1"],
    position: BOARD_POSITION_HINTS.swampRejoin,
  },
  {
    id: "cliff-1",
    name: "Cliff Steps",
  ...
  },
  {
    ...
    position: BOARD_POSITION_HINTS.cliffEvent,
  },
  {
    id: "cliff-trap",
    name: "Loose Ledge",
  ...
  },
  {
    ...
    region: "Jungle",
    risk: "safe",
    nextSpaceIds: ["jungle-event", "deep-jungle-1"],
    position: BOARD_POSITION_HINTS.jungleFork,
  },
  {
    id: "deep-jungle-1",
    name: "Deep Jungle Gate",
    type: "trap",
    region: "Deep Jungle",
    risk: "danger",
    nextSpaceIds: ["deep-jungle-2"],
    position: BOARD_POSITION_HINTS.deepJungle1,
  },
  {
    id: "deep-jungle-2",
  ...
  },
  {
    ...
    region: "Deep Jungle",
    risk: "danger",
    nextSpaceIds: ["deep-jungle-4"],
    position: BOARD_POSITION_HINTS.deepJungle3,
  },
  {
    id: "deep-jungle-4",
    name: "Hidden Prize Trail",
    type: "coin",
    region: "Deep Jungle",
    risk: "danger",
    nextSpaceIds: ["jungle-rejoin"],
    position: BOARD_POSITION_HINTS.deepJungle4,
  },
  {
    id: "jungle-event",
    name: "Parrot Path",
